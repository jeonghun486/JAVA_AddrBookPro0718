...
public class WinMemberDetail extends JDialog {
	...
	public WinMemberDetail(String id) throws Exception {
		setIconImage(Toolkit.getDefaultToolkit().getImage(WinMemberDetail.class.getResource("/images/MemberInsert.png")));
		...
		lblPic = new JLabel("");
		lblPic.setIcon(new ImageIcon(WinMemberDetail.class.getResource("/images/MemberInsert.png")));
		...
		JButton btnInsert = new JButton("\uB2EB\uAE30");
