...
public class WinMemberDelete extends JDialog {
	...
	public WinMemberDelete(String id) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(WinMemberDelete.class.getResource("/images/MemberInsert.png")));
		setTitle("삭제할 동창회원 자세히 보기" + id);
		...
		lblPic = new JLabel("");
		lblPic.setIcon(new ImageIcon(WinMemberDelete.class.getResource("/images/MemberInsert.png")));
		...
		JButton btnInsert = new JButton("회원탈퇴");
	...
	protected void DeleteMember(String id) throws Exception {
		...
		String sql = "delete from addressbooktbl where idx =" + id ;
